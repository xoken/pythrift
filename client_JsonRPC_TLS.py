...
while True:
    ...
    x8 = json.dumps({"id": 8, "jsonrpc" : "2.0",  "method" : 'ADDR->[OUTPUT]', "params" : {"gaAddrOutputs" : '13n561iVozTtMXJzAJNA5TQsnTboRvpxae'}}).encode('utf-8')
    ...
    x10 = json.dumps({"id" : 10, "jsonrpc" : "2.0",  "method": 'TXID->[MNODE]', "params" : { "gmbMerkleBranch": '54c693db802d83596e3a0cdec1f99dc01af246ca51b82adaad2f41e0a8fb2131'}}).encode('utf-8')

    x11 = json.dumps({"id" : 11, "jsonrpc" : "2.0",  "method": 'NAME->[OUTPOINT]', "params" : {"gaName": '[h', "gaIsProducer": True}}).encode('utf-8')
    ...
    x12 = json.dumps({"id": 12, "jsonrpc" : "2.0",  "method": 'RELAY_TX', "params": {"rTx" : rTx }}).encode('utf-8')
